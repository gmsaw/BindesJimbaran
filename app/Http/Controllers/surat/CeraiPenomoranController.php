...
class CeraiPenomoranController extends Controller
{
  /**
  ...
  public function index()
  {
    ...
    $counters = NomorSuratCounterCerai::orderBy('kode_surat')->orderBy('tahun', 'desc')->paginate(15);

    return view('pages.surat.penomoran.cerai_index', [
      'title' => 'Manajemen Penomoran Surat Cerai',
      'counters' => $counters,
    ]);
  }
  ...
  public function store(Request $request)
  {
    ...
    $request->validate([
      'kode_surat' => [
        ...
        Rule::unique($connectionName . '.nomor_surat_counter_cerai')->where(function ($query) use ($request) {
    ...
    NomorSuratCounterCerai::create($request->all());
...
//    dd($request->all());
    ...
    $counter = NomorSuratCounterCerai::where('kode_surat', $request->input('kode_surat'))
