...
@section('maincontent')
  ...
  <main class="flex-1 overflow-y-auto p-4 sm:p-6 bg-gray-50">
    <div class="container mx-auto px-4 py-8">
      ...
      <!-- Header Halaman -->
      <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-800">Menu Utama Kependudukan Krama Tamiu</h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
          ...
          <div class="p-6 flex flex-col justify-between h-auto">
            ...
            <a href="{{ route('kependudukan.index', ['krama_request' => 'krama_tamiu']) }}" class="w-full text-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
              Masuk
            </a>
          </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
          ...
          <div class="p-6 flex flex-col justify-between h-auto">
            ...
            <a href="{{ route('penduduk.index', ['krama_request' => 'krama_tamiu']) }}" class="w-full text-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition">
              Masuk
            </a>
          </div>
        </div>
