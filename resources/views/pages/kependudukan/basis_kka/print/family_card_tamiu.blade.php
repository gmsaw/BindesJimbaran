...
<div class="watermark-container w-[297mm] h-[210mm] border border-gray-400 mx-auto relative overflow-hidden">
  ...
  <div class="bg-black">
    <div class="flex gap-[8rem] justify-between items-center">
      ...
      <div class="text-center flex-1">
        <h1 class="text-3xl font-bold uppercase text-white">Majelis Desa Adat (MDA) Bali</h1>
        <h2 class="text-3xl font-bold uppercase text-white">Desa Adat Jimbaran</h2>
        <p class="text-xl font-bold text-white">Kecamatan Kuta Selatan, Kabupaten Badung</p>
      </div>
  ...
  <!-- Informasi Tambahan -->
  <div class="mt-2 mb-[0.5rem] flex justify-center">
    <div class="flex gap-[5.5rem] text-[11px]">
      <!-- Kolom kiri -->
      <div class="text-left space-y-1">
        ...
        <div class="flex">
          <div class="w-40 text-left font-bold">Agama</div>
          <div class="pl-0 uppercase">: {{ $kepala_keluarga->masterAdat?->masterIndividu?->agama ?? '............................' }}</div>
        </div>
      </div>
      ...
      <div class="text-left space-y-1">
        ...
        <div class="flex">
          <div class="w-40 text-left font-bold">Desa</div>
          <div class="pl-0">: {{ $adder->desa ?? '............................' }}</div>
        </div>
        ...
        <div class="flex">
          <div class="w-40 text-left font-bold">Provinsi</div>
          <div class="pl-0">: {{ $adder->kabupaten ?? '............................' }}</div>
        </div>
      </div>
    </div>
  ...
  {{--Kolom tanda tangan--}}
  <div class="mt-[0.1rem] mb-2 flex justify-center ml-15">
