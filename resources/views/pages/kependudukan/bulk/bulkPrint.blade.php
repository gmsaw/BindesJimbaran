...
{{-- Lakukan perulangan untuk setiap KK dalam daftar --}}
@foreach ($kk_list as $kk_adat)

  @php
    $kepala_keluarga = $kk_adat->anggota->firstWhere('status_hubungan_adat', 'kepala_keluarga');
    $keterangan_keluarga = $kk_adat->keteranganKeluarga;
    $anggota_list = $kk_adat->anggota;
  @endphp

  {{-- Ini adalah satu halaman penuh untuk satu KK --}}
  {{-- File: resources/views/pages/kependudukan/partials/kartu_keluarga_layout.blade.php --}}
  ...
  <div class="text-center mt-2">
    ...
    <p class="text-2xl font-bold uppercase mt-1">NPK: {{ $kk_adat->npk ?? '............................' }}</p>
  </div>
  ...
  {{-- Jangan tampilkan page-break untuk item terakhir --}}
  @if (!$loop->last)
