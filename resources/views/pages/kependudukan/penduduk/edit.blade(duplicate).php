...
@section('maincontent')
  <div class="flex-1 overflow-y-auto p-4 sm:p-6 bg-gray-50">
    <div class="container mx-auto px-4 py-8 max-w-4xl">
      {{-- FORM UTAMA UNTUK UPDATE DATA --}}
      <form action="{{ route('penduduk.update', ['nika' => $krama->nika]) }}" method="POST" enctype="multipart/form-data" id="main-form">
        @csrf
        @method('PUT')
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          ...
          <div class="mt-4 sm:mt-0 flex gap-x-2">
            <a href="{{ route('penduduk.index', ['banjar' => $krama->kode_banjar_fk]) }}" class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-300 rounded-lg shadow-sm">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
              ...
              <div class="flex flex-col items-center">
                <img id="image-preview" src="{{ asset($krama->masterIndividu->path_foto ?? 'https://placehold.co/400x480/e2e8f0/e2e8f0?text=') }}" alt="Foto Profil" class="w-48 h-[225px] object-cover rounded-lg shadow-md mb-4">

                <input type="file" name="path_foto" id="file-input" class="text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" accept="image/*">
                ...
                @if($krama->masterIndividu->path_foto)
                  <div class="w-full mt-3 pt-3 border-t">
                    <button type="submit" name="action" value="delete_photo"
                            class="w-full text-center px-4 py-2 bg-red-600 text-white text-sm rounded-md hover:bg-red-700 transition"
            ...
            <div class="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {{-- PERBAIKAN: Melengkapi semua field input --}}
