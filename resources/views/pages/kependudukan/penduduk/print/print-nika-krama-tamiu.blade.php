  ...
  <div class="flex-grow flex justify-between items-start mt-3 px-3">
    <div class="space-y-1.5 text-[10px] leading-tight">
      ...
      <div class="flex">
        ...
        <div class="pl-0">: {{ ucwords($adder->desa_adat ?? null) ?? '..................' }}</div>
      </div>
      <div class="flex">
...
<div class="card-page bg-white mx-auto relative overflow-hidden flex flex-col">
  <!-- HEADER -->
  <div class="h-[8mm] bg-yellow-400 mb-3 flex items-center justify-center">
  ...
  <!-- FOOTER -->
  <div class="h-[5mm] bg-yellow-400 mt-auto"></div>
</div>
