  ...
  <div class="flex-grow flex justify-between items-start mt-3 px-3">
    <div class="space-y-1.5 text-[10px] leading-tight">
      ...
      <div class="flex">
        ...
        <div class="pl-0">: {{ ucwords($krama->masterIndividu->jenis_kelamin) ?? '..................' }}</div>
      </div>
      <div class="flex">
        <div class="w-20 text-left">Agama</div>
        <div class="pl-0">: {{ ucwords($krama->masterIndividu->agama) ?? '..................' }}</div>
      </div>
      <div class="flex">
      ...
      <div class="flex">
        <div class="w-20 text-left">Desa Adat Asal</div>
        <div class="pl-0">: {{ ucwords($adder->desa) ?? '..................' }}</div>
      </div>
      <div class="flex">
    ...
    <div class="flex-shrink-0 flex flex-col items-center space-y-4">
      <div class="w-[25mm] h-[30mm] border border-gray-700 flex items-center justify-center text-[10px] bg-gray-100">
        @if($krama->masterIndividu->path_foto == null)
          <img src="{{ asset('storage/photos/blank-space/blank-profile-picture.webp') }}" class="w-[25mm] h-[29mm]" alt="Pas Foto">
        @else
          <img src="{{ asset($krama->masterIndividu->path_foto) }}" alt="Pas Foto">
        @endif
      </div>
...
<div class="card-page bg-white mx-auto relative overflow-hidden flex flex-col">
  <!-- HEADER -->
  <div class="h-[8mm] bg-black mb-3 flex items-center justify-center">
  ...
  <div class="flex-grow flex overflow-hidden px-3">
    <div class="w-1/3 flex-shrink-0 space-y-4">
      <div class="text-[9px] text-center">
        ...
        <p class="font-semibold underline">{{ $bendesa_adat->nama_bendesa ?? 'BENDESA ADAT JIMBARAN' }}</p>
      </div>
      ...
      <div class="text-[9px] text-center">
        ...
        <p>TIM BINDES JIMBARAN UDAYANA</p>
      </div>
    </div>
  ...
  <!-- FOOTER -->
  <div class="h-[5mm] bg-black mt-auto"></div>
</div>
