    ...
    <div>
      ...
      <div>
        <div class="ml-[5rem] mr-[3rem] mt-[0.75rem] leading-[1.25rem]">
          ...
          <p class="text-justify">Pada tanggal : 31 Januari 2022, atas dasar kesepakatan kedua belah pihak disaksikan oleh pihak keluarga laki-laki dan pihak keluarga perempuan, beserta aparat Desa Adat dan Dinas.</p>
        </div>
      </div>
