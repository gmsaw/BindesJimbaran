...
<head>
  <meta charset="UTF-8">
  <title>Surat Kawin - {{$surat->id}}</title>
    ...
    <div>
      ...
      <div>
        <div class="ml-[5rem] mr-[3rem] mt-[0.75rem] leading-[1.25rem]">
          ...
          <p class="text-justify">Pada tanggal : {{\Carbon\Carbon::parse($surat->tanggal_kawin)->translatedFormat('d F Y') ?? ".................." }}, dan yang berkedudukan sebagai PURUSA adalah {{$surat->pradana_nama ?? ".................."}} dan ini merupakan perkawinan yang sah.</p>
        </div>
      </div>
